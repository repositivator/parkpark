...
public class Parking implements DataInter{
   ...
   //내가등록한 주차장 수정화면(개별 주차장 정보 가져오기)
   @Override
	public S_ParkingDto myParkinglotIndividualData(ParkingBean bean) throws DataAccessException {
		return parkingInter.myParkinglotIndividualData(bean);
	}
}