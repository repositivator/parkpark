...
<br/>
<div id="signup">
	<form name="regForm" method="post" action="memberint">
		<table style="width:60%;" >
			<tr align="center" style="background-color: #1BA4E7">
				<td colspan="2"><b style="color:#5e0231">ParkPark! - Signup</b></td>
			</tr>
			<tr>
			...
			<tr>
				<td>
				<p class="tPad20"><input type="checkbox" id="agreeUse" name="agreeUse" class="check" /> <label for="agreeUse"> <strong><a href="#" id="modify" style="color:#9d9d9d;" data-toggle="modal" data-target="#agreeUseModal">‘이용약관‘</a></strong>에 동의 합니다.</label></p>
				</td>
			</tr>
			<tr>
				<td>
				<p class="tPad20"><input type="checkbox" id="agreePrivate" name="agreePrivate" class="check" /> <label for="agreePrivate"> <strong><a href="#" id="modify" style="color:#9d9d9d;" data-toggle="modal" data-target="#agreeagreePrivateModal">‘개인정보 보호를 위한 이용자 동의사항‘</a></strong>에 동의 합니다.</label></p>
				</td>
			</tr>
			...
			<tr>
				<td colspan="2" align="center">
					<input type="button"
					value="회원가입" id="btnSubmit" class="btn btn-primary"  style="background-color: #1BA4E7; border:0px;">
